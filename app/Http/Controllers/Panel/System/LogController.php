...
{
    private $route;
    private $viewsPath = 'panel.system.log.';
    private $paginate = 25;
    ...
    public function __construct()
    {
        ...
        $this->route = url('panel/system/logs');
    }
    ...
    {
        $logs = Log::orderBy('CTOLog_Timestamp', 'DESC')->paginate($this->paginate);
    ...
    public function showInfo(Request $request, $id)
    {
        ...
        $viewData = [
            ...
            'navigation' => [
                'base' => $this->route,
                'pagination' => $logs->setPath("{$this->route}")->links(),
                'page' => ($request->has('page')) ? $request->page : 0,
            ],
