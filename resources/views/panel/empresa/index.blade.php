...
<nav class="navbar navbar-default">
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#modalCartaPoder" data-toggle="modal" data-target="#modalCartaPoder">Carta poder</a></li>
            <li><a href="#modalEnvios" data-toggle="modal" data-target="#modalEnvios">Envíos</a></li>
            <li><a href="#modalOficios" data-toggle="modal" data-target="#modalOficios">Oficios</a></li>
          </ul>
        </li>
	...
	@include('panel.empresa.comunicaciones.carta_poder');
  @include('panel.empresa.comunicaciones.envios');
  @include('panel.empresa.comunicaciones.oficios');
@endsection