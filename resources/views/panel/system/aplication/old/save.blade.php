								...
								<table class="table table-info">
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="form-group">
													...
													<select name="cto34" class="form-control form-control-plain input-sm">
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<label for="cto34_type" class="form-label-full">Cliente</label>
													<select name="cto34" class="form-control form-control-plain input-sm">
														<option selected disabled></option>
														<option></option>
														<option></option>
											...
											<td>
												<div class="form-group">
													<label for="cto34_class" class="form-label-full">Obra</label>
													<select name="cto34" class="form-control form-control-plain input-sm">
														<option selected disabled></option>
														<option></option>
														<option></option>
										...
										<tr>
											<td colspan="2">
												<div class="form-group">
													<label for="cto34_description" class="form-label-full">Contrato</label>
													<select name="cto34" class="form-control form-control-plain input-sm">
														<option selected disabled></option>
														<option></option>
														<option></option>
											...
											<td colspan="3">
												<div class="form-group">
													...
													<textarea id="cto34_description" 
														...
														placeholder="text" maxlength="4000"
														class="form-control form-control-plain input-sm" > 
