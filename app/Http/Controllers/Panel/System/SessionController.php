...
{
    private $route;
    private $viewsPath = 'panel.system.session.';
    private $paginate = 25;
    ...
    public function __construct()
    {
        ...
        $this->route = url('panel/system/sessions');
    }
    ...
    {
        $sessions = Session::orderBy('SesionIniciaTimestamp', 'DESC')->paginate($this->paginate);
    ...
    public function showInfo(Request $request, $id)
    {
        ...
        $viewData = [
            ...
            'navigation' => [
                'base' => $this->route,
                'pagination' => $sessions->setPath("{$this->route}")->links(),
                'page' => ($request->has('page')) ? $request->page : 0,
            ],
