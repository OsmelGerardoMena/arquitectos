                        ...
                        <div class="panel-body">
                            <div class="list-group col-sm-5 col-md-4 col-lg-3 margin-clear panel-item" style="position: relative;">
                                ...
                                @foreach ($sessions['all'] as $index => $session)
                                    @if ($session->TbCTOSesionID == $sessions['one']->TbCTOSesionID)
                            ...
                            <div>
                                <div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
                                    ...
                                    @include('panel.system.currency.shared.delete-form', [
                                        'title' => 'Sesión',
                                        'name' => $sessions['one']->CTOUsuarioNombre,
                                        'id' => $sessions['one']->user->TbCTOSesionID,
                                    ])
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group col-sm-12">
                                            <label>Usuario</label>
                                            <p>{{ $sessions['one']->user->CTOUsuarioNombre  }} - {{ $sessions['one']->user->person->PersonaAlias  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Fecha Inicia</label>
                                            <p>{{ $sessions['one']->SesionIniciaTimestamp }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Fecha Termina</label>
                                            <p>{{ $sessions['one']->SesionTerminaTimestamp }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Duración</label>
                                            <p>{{ $sessions['one']->SesionDuracion  }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
