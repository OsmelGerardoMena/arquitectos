			...
			<div class="navbar navbar-static-top navbar-inverse margin-bottom--clear">
				<div class="container-fluid">
					<div class="navbar-header">
						<p class="navbar-text">
							{{ $page['title'] }} / {{ $items['one']->RubroAlias }}
						</p>
					</div>
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								<a href="{{ $navigation['base'] }}/update/{{ $items['one']->tbRubroID }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'] : '' }}" class="is-tooltip" data-placement="bottom" title="Editar">
									<span class="fa-stack fa-lg">
										<i class="fa fa-circle fa-stack-2x"></i>
						...
						<div class="panel-body padding-clear">
							...
							<div>
								<div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
									...
									@include('panel.system.item.shared.delete-form')
										...
										<table class="table table-info">
											<tbody>
												...
												<tr>
													...
													<td>
														<label>Estatus</label>
														<p class="help-block">{{ $items['one']->RegistroCerrado == 1?'Cerrado':'Inactivo' }}</p>
													</td>
												</tr>
											</tbody>
										</table>
