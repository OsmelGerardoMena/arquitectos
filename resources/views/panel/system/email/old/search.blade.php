							...
							<div class="list-group col-sm-5 col-md-4 col-lg-3 margin-clear panel-item" style="position: relative;">
								...
								@foreach ($emails['all'] as $index => $b)
									@if ($index == 0)
										...
										@continue
									@endif
									<a href="{{ $navigation['base'] }}/search/info/{{ $b->TbCorreoCtasID  }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'].'&q='.$search['query'] : '?q='.$search['query'] }}" class="list-group-item">
								...
								<div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
									...
									<span class="fa-stack fa-lg">
										...
										<i class="fa fa-filter fa-stack-1x fa-inverse"></i>
                                            ...
                                            <li>
                                                <a href="{{ $navigation['base'] }}/update/{{ $emails['all'][0]->TbCorreoCtasID }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'].'&q='.$search['query'] : '?q='.$search['query'] }}" class="is-tooltip" data-placement="bottom" title="Editar">
									<span class="fa-stack fa-lg">
										<i class="fa fa-circle fa-stack-2x"></i>
