						...
						<div class="panel-body">
							<div class="list-group col-sm-5 col-md-4 col-lg-3 margin-clear panel-item" style="position: relative;">
								...
								@foreach ($phones['all'] as $index => $b)
									@if ($index == 0)
										<a href="{{ $navigation['base'] }}/info/{{ $b->tbDirTelefonoID  }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'] : '' }}" class="list-group-item active">
								...
								<div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
									...
									<span class="fa-stack fa-lg">
										...
										<i class="fa fa-filter fa-stack-1x fa-inverse"></i>
											...
											@if (count($phones['all']) > 0)
												<li>
													<a href="{{ $navigation['base'] }}/update/{{ $phones['all'][0]->tbDirTelefonoID }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'] : '' }}" class="is-tooltip" data-placement="bottom" title="Editar">
									<span class="fa-stack fa-lg">
										<i class="fa fa-circle fa-stack-2x"></i>
