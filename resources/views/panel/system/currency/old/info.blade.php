					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							@if (count($currencies['all']) > 0)
								<li>
									<a href="{{ $navigation['base'] }}/update/{{ $currencies['one']->tbMonedasID }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'] : '' }}" class="is-tooltip" data-placement="bottom" title="Editar">
									<span class="fa-stack fa-lg">
										<i class="fa fa-circle fa-stack-2x"></i>
								...
								<div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
									...
									<div class="col-sm-12 margin-bottom--20">
										<div class="col-sm-4">
											...
											<p class="helper-text">{{ $currencies['one']->tbMonedasID }}</p>
										</div>
										<div class="col-sm-8">
