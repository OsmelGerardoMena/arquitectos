								...
								<div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
									...
									<span class="fa-stack fa-lg">
										...
										<i class="fa fa-filter fa-stack-1x fa-inverse"></i>
                                            ...
                                            <li>
                                                <a href="{{ $navigation['base'] }}/update/{{ $business['all'][0]->tbDirEmpresaID }}{{ ($navigation['page'] > 0) ? '?page='.$navigation['page'].'&q='.$search['query'] : '?q='.$search['query'] }}" class="is-tooltip" data-placement="bottom" title="Editar">
									<span class="fa-stack fa-lg">
										<i class="fa fa-circle fa-stack-2x"></i>
                                                ...
                                                <div role="tabpanel" class="tab-pane active" id="general">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-sm-8">
                                                            <label>Alias</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaAlias) }}</p>
                                                            <label>Razón Social</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaRazonSocial) }}</p>
                                                            <label>Nombre Comercial</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaNombreComercial) }}</p>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">Dependencia</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaDependencia) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">Especialidad</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaEspecialidad) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaSlogan) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">Página web</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaPaginaWeb) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">RFC</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaRFC) }}</p>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">Número de IMSS</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaIMSSNumero) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label class="form-label-full">Número de INFONAVIT</label>
                                                            <p class="help-block">{{ ifempty($business['all'][0]->EmpresaINFONAVITNumero) }}</p>
                                                        </div>
                                                        <div class="form-group col-sm-4">
