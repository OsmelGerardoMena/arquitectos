...
@section('content')
								...
								<table class="table table-info">
									<tbody>
											...
											<td>
												<div class="form-group">
													...
													<input id="cto34_cuota_trabajador" 
														...
														type="text" 
														value="{{ old('cto34_cuota_trabajador') }}"
														placeholder="60"
														class="form-control form-control-plain input-sm">
												</div>
											</td>											
										...
										<tr>
											...
											<td>
												<div class="form-group">
													<label for="cto34_estatus" class="form-label-full">Estatus</label>
	...
	{{-- </data-content> --}}
	{{-- Modal para filtrar --}}
	@include('panel.system.imss.shared.filter-modal', ['navigation' => $navigation])
@endsection
