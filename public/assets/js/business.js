var Business = (function() {
     ...
     * @return void
     */
    Business.prototype.saveWithAjax = function(form, callback) {
     ...
     * @return void
     */
    /*Business.prototype.searchWithAjax = function(element, options) {
    ...
    Business.prototype.searchWithAjax = function(element, options, callback) {
        ...
        var searchClientOptions = {
            ...
            preprocessData: function (data) {
                var i, l = data.business.length, array = [];
                ...
                if (l) {
                    ...
                    for (i = 0; i < l; i++) {
                        ...
                        array.push({
                            text : data.business[i].EmpresaAlias,
                            value: data.business[i].tbDirEmpresaID,
    ...
    Business.prototype.searchInMyBusinessWithAjax = function(element, options, callback) {
            ...
            preprocessData: function (data) {
                ...
                if (l) {
                    for (i = 0; i < l; i++) {
                        ...
                        if (data.businessAll[i].business != null) {

                            array.push({
                                text : data.businessAll[i].business.EmpresaAlias,
                                value: data.businessAll[i].tbDirEmpresaMiEmpresaID,
                                class: (options.hasOwnProperty('optionListClass')) ? options.optionListClass : ''
                            });
                        }
                    }
