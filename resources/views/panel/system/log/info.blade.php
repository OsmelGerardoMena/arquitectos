                        ...
                        <div class="panel-body">
                            <div class="list-group col-sm-5 col-md-4 col-lg-3 margin-clear panel-item" style="position: relative;">
                                ...
                                @foreach ($logs['all'] as $index => $log)
                                    @if ($log->tbCTOID == $logs['one']->tbCTOID)
                            ...
                            <div>
                                <div class="col-sm-7 col-md-8 col-lg-9 panel-item padding-left--clear padding-right--clear" style="position: relative;">
                                    ...
                                    --}}
                                    @include('panel.system.business.shared.delete-form', ['business' => [ 'one' => $logs['one']]])
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group col-sm-12">
                                            <label>Usuario</label>
                                            <p>{{ $logs['one']->user->CTOUsuarioNombre  }}  - {{ $logs['one']->user->person->PersonaAlias  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Tabla</label>
                                            <p>{{ $logs['one']->CTOLog_Tabla  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Acción</label>
                                            <p>{{ $logs['one']->CTOLog_Accion  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Registro</label>
                                            <p>{{ $logs['one']->CTOLog_Registro  }}</p>
                                        </div>
                                        <div class="clearfix"></div>
                                        <div class="form-group col-sm-4">
                                            <label>Campo</label>
                                            <p>{{ $logs['one']->CTOLog_Campo  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Valor anterior</label>
                                            <p>{{ $logs['one']->CTOLog_ValorOLD  }}</p>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Valor nuevo</label>
                                            <p>{{ $logs['one']->CTOLog_ValorNEW  }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
